    ...
    return (
        ...
        >
            ...
            <Card className="shadow-2xl border-0 overflow-hidden relative">
                ...
                {/* Celebration Header */}
                <div className="bg-gradient-to-br from-brand-blue via-blue-700 to-indigo-900 p-8 text-center text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <motion.div
                            ...
                            className="mt-6 inline-block bg-white/10 backdrop-blur-md rounded-2xl px-6 py-3 border border-white/20"
                        >
                ...
                <CardContent className="p-6 relative z-10 bg-white dark:bg-gray-950">
                    {/* Score Message */}
                    <motion.div
                    ...
                    >
                        <p className="text-xl text-gray-800 dark:text-gray-100 font-bold leading-tight">
                            {getScoreMessage()}
                        </p>
                    </motion.div>
                    ...
                    >
                        <Button
                            ...
                            className="w-full h-16 text-xl font-black bg-gradient-to-r from-brand-orange to-orange-600 hover:from-orange-600 hover:to-brand-orange text-white rounded-2xl shadow-xl shadow-orange-200 dark:shadow-orange-950/20 flex items-center justify-center gap-3 transform transition hover:scale-[1.02] active:scale-95"
                        >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Button
                                onClick={onCallNow}
                                variant="outline"
                                className="h-14 font-bold border-2 border-green-500 text-green-600 hover:bg-green-50 rounded-xl flex items-center justify-center gap-2"
                            >
                            ...
                            <Button
                                onClick={onBookSlot}
                                variant="outline"
                                className="h-14 font-bold border-2 border-brand-blue text-brand-blue hover:bg-blue-50 rounded-xl flex items-center justify-center gap-2"
                            >
