...
export const quizQuestions = [
    {
        ...
        explanation: 'With 0% GST, life insurance premiums have become more affordable as customers no longer need to pay the additional tax on their premiums.'
    },
    {
        id: 2,
        category: 'GST',
        ...
        explanation: 'The 0% GST exemption extends to all riders attached to life insurance policies, making them more affordable too.'
    },
    {
        id: 3,
        category: 'GST',
        ...
        correctAnswer: 'Lower',
        explanation: 'With 0% GST instead of 18%, your premium will be lower as you no longer pay the tax component.'
    },
    {
        id: 4,
        category: 'GST',
    ...
    },
    {
        ...
        explanation: 'The 0% GST exemption applies to all customers buying any type of life insurance product, including term, ULIP, endowment, and pension plans.'
    }
];
